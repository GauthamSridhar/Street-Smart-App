...
public class ProductController {
  ...
  public ResponseEntity<ProductResponseDTO> addProduct(
      @RequestParam UUID shopId, @Valid @RequestBody AddProductRequest productRequest) {
  ...
  public ResponseEntity<ProductResponseDTO> updateProduct(
      @PathVariable UUID productId, @Valid @RequestBody AddProductRequest productRequest) {
